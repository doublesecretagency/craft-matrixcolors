...
- _**NEW:** Added support for Neo block types!_

---

## How to Install

See official installation instructions on the [Craft CMS Plugin Store...](https://plugins.craftcms.com/matrix-colors)
...
<p align="center">
    <strong>Settings > Plugins > Matrix Colors</strong>
</p>
...
If you are also using the [Neo](https://plugins.craftcms.com/neo) plugin, you can similarly color your Neo blocks.
